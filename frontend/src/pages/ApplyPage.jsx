...
const ApplyPage = () => {
  ...
  const copy = {
    en: {
      ...
      requirements: [
        'GCE A-Level / BACC Certificate: 01 clear photocopy of your diploma or official transcript.',
    ...
    fr: {
      ...
      requirements: [
        'Certificat GCE A-Level / BACC : 01 photocopie claire de votre diplôme ou relevé officiel.',
        '01 photocopie de votre Carte Nationale d’Identité (CNI) et 01 photocopie de votre acte de naissance.',
        'Fournitures de bureau : 02 rames de papier Double A pour les devoirs académiques et les examens.',
        '04 photos passeport récentes format 4x4.',
        '01 douzaine de papier hygiénique Sitta (12 rouleaux).',
        '10 000 FCFA pour la visite médicale obligatoire sur le campus.',
