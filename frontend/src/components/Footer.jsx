...
const Footer = () => {
  ...
  const copy = {
    ...
    fr: {
      tagline: "L'Université Entrepreneuriale. Former la prochaine génération de leaders par l'innovation, la foi et l'excellence professionnelle.",
      quick: 'Liens rapides',
      mission: 'Mission & Vision',
