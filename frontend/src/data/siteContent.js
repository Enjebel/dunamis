...
• Club de Technologie: un centre d innovation avec quatre sous-sections specialisees en ingenierie et technique:
  o IT & Informatique: developpement logiciel, codage et maintenance des systemes.
  o Genie Civil: introduction pratique au batiment, a la construction et aux projets d infrastructure.
  o Genie Electrique: manipulation pratique des systemes d energie et de l electronique automatisee.
  o Genie Geographique & Topographique: arpentage, cartographie numerique et gestion spatiale.
• Club de Sport: entrainement physique concu pour renforcer la sante et l esprit d equipe autour de trois disciplines principales:
  ...
  o Handball: entrainement axe sur l agilite, la vitesse et la strategie collective.
...
export const navigation = [
  ...
  },
  {
    ...
    children: [
      ...
      ['Student Benefits', 'Avantages Etudiants', '/admission/benefits'],
  ...
  { id: 'international', path: '/international' },
  {
    ...
    children: [
      ...
      ['Student Bureau (S.B.)', 'Bureau des Etudiants (B.E.)', '/student-life/bureau'],
    ],
  },
