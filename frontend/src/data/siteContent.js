...
export const pages = {
  university: {
    ...
    en: {
      ...
      sections: [
        ...
        { title: 'Faculty', text: 'Lecturers, industry mentors, and practitioners support every student pathway.' },
    ...
    fr: {
      ...
      sections: [
        ...
        { title: 'Corps enseignant', text: 'Enseignants, mentors industriels et praticiens accompagnent chaque parcours.' },
  ...
  apprenticeship: {
    ...
    en: {
      ...
      intro: 'The Dunamis work-study rhythm gives students professional experience while they learn.',
      sections: [
        { title: 'How it works', text: 'Students alternate campus training and company practice each week.' },
        { title: 'Partner companies', text: 'Employers co-train students through missions, mentorship, and real deliverables.' },
        { title: 'Finding a company', text: 'Career teams help students prepare applications, interview, and match with host companies.' },
        { title: '100% apprenticeship classes', text: 'Dedicated cohorts make the rhythm predictable for learners and employers.' },
        { title: 'Steps for your apprenticeship', text: 'Choose a program, prepare your profile, interview, sign your agreement, then begin the rhythm.' },
      ],
    },
    fr: {
      eyebrow: 'Alternance',
      title: '3 jours en cours, 3 jours en entreprise',
      intro: 'Le rythme Dunamis permet aux etudiants d acquerir une experience professionnelle pendant leur formation.',
      sections: [
        { title: 'Comment ca marche', text: 'Les etudiants alternent formation au campus et pratique en entreprise chaque semaine.' },
        { title: 'Entreprises partenaires', text: 'Les employeurs co-forment les etudiants avec missions, mentorat et livrables reels.' },
        { title: 'Trouver une entreprise', text: 'Les equipes carriere aident a preparer dossiers, entretiens et mise en relation.' },
        { title: 'Classes 100% alternance', text: 'Des cohortes dediees rendent le rythme clair pour les apprenants et les entreprises.' },
        { title: 'Etapes de votre alternance', text: 'Choisir un programme, preparer son profil, passer les entretiens, signer, puis commencer.' },
      ],
    },
  },
  international: {
